...
CSP_CONNECT_SRC = ("'self'", "*.google-analytics.com", "maps.googleapis.com", "stats.g.doubleclick.net", "plausible.io", "*.clarity.ms", "c.bing.com", "api.ratings.food.gov.uk", "www.google.com")
