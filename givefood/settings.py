...
CSP_FRAME_SRC = ("'self'", "*")
CSP_SCRIPT_SRC = ("'self'", "'unsafe-inline'", "'unsafe-eval'", "instant.page", "*.googleanalytics.com", "*.google-analytics.com", "ajax.googleapis.com", "cdnjs.cloudflare.com", "www.gstatic.com", "www.googletagmanager.com", "maps.googleapis.com", "connect.facebook.net","platform.twitter.com", "cdn.syndication.twimg.com", "syndication.twitter.com", "www.googleadservices.com", "googleads.g.doubleclick.net", "plausible.io", "*.clarity.ms", "c.bing.com")
...
CSP_CONNECT_SRC = ("'self'", "plus.google.com", "www.google-analytics.com", "maps.googleapis.com", "stats.g.doubleclick.net", "plausible.io", "*.clarity.ms", "c.bing.com")
