...
CSP_FRAME_SRC = ("'self'", "*")
CSP_SCRIPT_SRC = ("'self'", "'unsafe-inline'", "'unsafe-eval'", "instant.page", "*.googleanalytics.com", "*.google-analytics.com", "ajax.googleapis.com", "cdnjs.cloudflare.com", "www.gstatic.com", "www.googletagmanager.com", "maps.googleapis.com", "connect.facebook.net","platform.twitter.com", "cdn.syndication.twimg.com", "syndication.twitter.com", "www.googleadservices.com", "googleads.g.doubleclick.net", "plausible.io", "*.clarity.ms", "c.bing.com", "*.cookiepro.com")
CSP_IMG_SRC = ("'self'", "data:", "s.ytimg.com", "*.googleusercontent.com", "*.gstatic.com", "www.google-analytics.com", "www.googletagmanager.com", "abs.twimg.com", "platform.twitter.com", "syndication.twitter.com", "pbs.twimg.com", "ton.twimg.com", "digitalcontent.api.tesco.com", "*.googleapis.com", "storage.googleapis.com", "www.google.com", "www.google.co.uk", "assets.sainsburys-groceries.co.uk", "*.ggpht.com", "googleads.g.doubleclick.net", "*.clarity.ms", "c.bing.com", "*.cookiepro.com")
CSP_CONNECT_SRC = ("'self'", "plus.google.com", "www.google-analytics.com", "maps.googleapis.com", "stats.g.doubleclick.net", "plausible.io", "*.clarity.ms", "c.bing.com", "*.cookiepro.com")
