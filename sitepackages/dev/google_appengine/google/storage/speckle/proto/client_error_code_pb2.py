...
_SQLSERVICECLIENTERROR_CLIENTERRORCODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ERROR_TOO_MANY_LOOKUP_INSTANCE_RPCS', index=42, number=1053,
      options=None,
      type=None),
  ],
